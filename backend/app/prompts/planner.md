...
- Allowed resume_search purposes only: birthday_person, birthday_cohort, location_person, location_cohort, location_facet, languages_person, languages_cohort, certifications_person, certifications_cohort, skills_person, experience_person, projects_person, status_resolve (and empty/purpose=skill for generic skill RAG)
